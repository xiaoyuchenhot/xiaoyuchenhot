# Task Instructions V3 — Balanced depth with focused output
...
## Goal
Review ALL cases in /CasesForReview. Classify each case's escalation risk. Focus your detailed analysis on the cases that truly matter — not every case is a risk.
...
**MEDIUM RISK CASES** — "These cases have potential for escalation due to slow progress, moderate impact, or customer frustration, but are not yet critical."

Same table format as High Risk.

**NO RISK CASES** — "These cases are on track with low impact. No Lead Customer Advocate review required."
